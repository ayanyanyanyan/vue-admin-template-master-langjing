  ...
  <div class="app-container">
    ...
    <el-form :inline="true" :model="searchEmp" class="demo-form-inline">
     ...
     <!--  <el-form-item label="性别">
        <el-select v-model="searchEmp.gender" placeholder="请选择" :clearable="true">
    ...
    <el-row>
      ...
      <el-button type="primary" size="medium" @click="dialogVisible = true; emp = { image: ''};" >+ 新增案例</el-button>
    </el-row>

    <!--添加数据对话框表单-->
    <el-dialog ref="form" title="编辑案例" :visible.sync="dialogVisible" width="30%">
    ...
    <template>
      <el-table :data="tableData" style="width: 100%" border @selection-change="handleSelectionChange">
        ...
        <el-table-column prop="image" label="案例图" align="center">
...
export default {
  data() {
    return {
      ...
      deptList: [],
      genderList: [{id: 1,name: "一类"},{id: 2,name: "二类"}], 
     /*  jobList: [
        {
          id: 1,
          name: "班主任",
